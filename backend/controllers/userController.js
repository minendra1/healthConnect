...
const bookAppointment = async (req, res) => {
    try {
        ...
        //checkiing for slot availability
        ...
        const userData = await userModel.findById(userId).select('-password')
        delete docData.slots_booked      //removing slots booked from doc data
        ...
        await newAppointment.save()  // Saving to database
...
//api for payment gateway integration
const paymentRazorpay = async (req, res) => {
    try {
        ...
        const options = {
            amount: appointmentData.amount * 100,  //to remove 2 decimal points
