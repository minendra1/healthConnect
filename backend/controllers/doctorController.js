...
//to get all appointments of a secific doctor
...
const appointmentComplete = async (req, res) => {
    try {
        ...
        // console.log(appointmentData, "docId", docId, "appointmentId", appointmentId)
...
//api to cancel appointment from doctorPanel
